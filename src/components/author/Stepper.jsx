...
import style from 'assets/jss/components/Stepper';
import Step1 from 'components/author/Stop1';
  ...
  return (
    <div>
      ...
      <Grid container justify="space-around" className={classes.buttonContainer}>
        <Button disabled={activeStep === 0} onClick={handleBack} variant="contained" color="primary" className={classes.nextButton}>Back</Button>
        <Button disabled={!editorId && !editorNameId} onClick={handleNext} variant="contained" color="primary" className={classes.nextButton}>{activeStep === 2 ? 'Finish' : 'Next'}</Button>
      </Grid>
