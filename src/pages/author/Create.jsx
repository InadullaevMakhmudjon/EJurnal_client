...
import style from 'assets/jss/pages/author';
import Container from '@material-ui/core/Container';
import Typography from '@material-ui/core/Typography';
import Grid from '@material-ui/core/Grid';
import Stepper from 'components/author/Stepper';
    ...
    <Container maxWidth="xl">
      ...
      <Container className={classes.container}>
        <Grid container justify="center" direction="column" className={classes.wraper}>
          <Typography variant="h4" align="center" className={classes.title}>Build Your Profile</Typography>
          <Typography
            variant="body1"
            align="center"
